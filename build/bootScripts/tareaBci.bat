...
set JARPATH=%APP_HOME%\lib\tareaBci-1.0-SNAPSHOT.jar

@rem Execute tareaBci
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %TAREA_BCI_OPTS%  -jar "%JARPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%TAREA_BCI_EXIT_CONSOLE%" exit 1
exit /b 1
